package com.bilitianx.technicalstorage.worldgen;
...
public class XtomWorldGen implements IWorldGenerator {
	@Override
	...
	private void generateOverworld(Random random, 
			...
			IChunkGenerator chunkGenerator, 
			IChunkProvider chunkProvider) {
		generateOre(BlockRegistryHandler.BLOCK_XTOM_ORE.getDefaultState(), 
				world,
				random,
				chunkX * 16,
				chunkZ * 16,
